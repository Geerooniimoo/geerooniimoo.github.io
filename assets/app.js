const images = [
    ...
    'firebase3.png', 'gamazon1.jpg', 'gamazon2.png', 'gamazon3.png', 'jup_2.png', 'jup_3.png', 'leaflet-map1.png', 'leaflet-map2.png', 'leaflet-map3.png', 'leaflet-map1.png', 'liri1.png', 'liri2.png', 'liri3.png', 'liri4.png','liri1.png','liri2.png', 'mars1.png', 'mars2.png', 'mars3.png', 'mars4.png', 'mars5.png', 'matplotlib_lab.jpg', 'matplotlib_boxplot.png', 'matplotlib_line.png', 'matplotlib_pie.png', 'matplotlib_regression.png', 'pandas-4.png', 'pandas-1.png', 'pandas-2.png', 'pandas-3.png', 'pandas-5.png', 'pandas-6.png', 'plotly_1.png', 'python0.png', 'python1.png', 'python2.png', 'python3.png', 'sql_bar.png', 'sql_hist.png', 'sqlalchemy_1.png', 'sqlalchemy_2.png', 'sqlalchemy_3.png', 'sqlalchemy_4.png', 'team.jpg', 'team1.png', 'team2.png', 'team3.png', 'vba0.jpg', 'vba1.png', 'vba2.png', 'vba3.png', 'vba4.png', 'vba5.png', 'vba6.png', 'vba7.png', 'vba8.png', 'web_1.png', 'web_2.png', 'web_3.png'
]

const speech =
    `Hi!
    here are some examples of the many things we can do together.
    For example with Tableau, 
    we can create detailed visualizations which proivdes a quick analysis into CitiBiki's data.
